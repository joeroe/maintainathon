...
This can be an effective way of managing your own work, as the issues serve as a 'to-do list' and on many platforms can be organised into various project management tools.
...
it means users can see if you're already aware of an issue, before reporting it themselves;
